                                   ...
                                   float q5, float q6)
{
...
#ifdef PRINT_DEBUG_INFO
    /* Display Results */
    ROS_INFO("API Rotation: X = %f, Y = %f, Z = %f, W = %f",
     ...
     *******				   										    *******/
    rot_matrix.setValue(cos((this->degToRad(-55)))*cos(q5),
                        cos((this->degToRad(-55)))*-sin(q5),
                        sin((this->degToRad(-55))),
                        sin(q5),
                        cos(q5),
                        0,
                        -sin((this->degToRad(-55)))*cos(q5),
                        sin((this->degToRad(-55)))*sin(q5),
                        cos((this->degToRad(-55))));
     ...
     * -sin(55)*D4      *
     ****     ****/
    translation_v.setValue(cos(this->degToRad(55))*this->J4ToJ5(), 0, -sin(this->degToRad(55))*this->J4ToJ5());
     ...
     *******				   										    *******/
    rot_matrix.setValue(cos((this->degToRad(55)))*cos(q6),
                        cos((this->degToRad(55)))*-sin(q6),
                        sin((this->degToRad(55))),
                        sin(q6),
                        cos(q6),
                        0,
                        -sin((this->degToRad(55)))*cos(q6),
                        sin((this->degToRad(55)))*sin(q6),
                        cos((this->degToRad(55))));
    rot_matrix.getRotation(rotation_q);
     ...
     * -sin(55)*D5       *
     ****     ****/
    translation_v.setValue(-cos(this->degToRad(55))*this->J5ToJ6(), 0, -sin(this->degToRad(55))*this->J5ToJ6());
