...
void JacoKinematics::UpdateForward(float q1, float q2, float q3, float q4,
	...
	/**********************API**********************/
		...
		rot_matrix.setValue(cos(3.14159/2), -sin(3.14159/2), 0, sin(3.14159/2), cos(3.14159/2), 0, 0, 0, 1);
	 ...
	 * D1        *
	 ****     ****/
	translation_v.setValue(0, 0, this->D1()/2);
	 ...
	 * D2        *
	 ****     ****/
	translation_v.setValue(this->D2(), 0, 0);
	 ...
	 * D2        *
	 ****     ****/
	translation_v.setValue(this->D3(), 0, 0);
	 ...
	 *******				   										    *******/
	rot_matrix.setValue(cos((this->deg_to_rad(-35)))*cos(q5),cos((this->deg_to_rad(-35)))*-sin(q5),sin((this->deg_to_rad(-35))), sin(q5), cos(q5), 0, -sin((this->deg_to_rad(-35)))*cos(q5), sin((this->deg_to_rad(-35)))*sin(q5), cos((this->deg_to_rad(-35))));
	 ...
	 * -sin(55)*D4      *
	 ****     ****/
	translation_v.setValue(cos(this->deg_to_rad(55))*this->D4(), 0, -sin(this->deg_to_rad(55))*this->D4());
	 ...
	 *******				   										    *******/
	rot_matrix.setValue(cos((this->deg_to_rad(35)))*cos(q6),cos((this->deg_to_rad(35)))*-sin(q6),sin((this->deg_to_rad(35))), sin(q6), cos(q6), 0, -sin((this->deg_to_rad(35)))*cos(q6), sin((this->deg_to_rad(35)))*sin(q6), cos((this->deg_to_rad(35))));
	 ...
	 * -sin(55)*D5       *
	 ****     ****/
	translation_v.setValue(-cos(this->deg_to_rad(55))*this->D5(), 0, -sin(this->deg_to_rad(55))*this->D5());
