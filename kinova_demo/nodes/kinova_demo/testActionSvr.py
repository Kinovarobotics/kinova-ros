...
if __name__ == '__main__':
  try:
    ...
    if (interactive == True):
      nb = input('Moving robot to candle like position, press return, n to skip')
    if (nb != 'n' and nb != 'N'):
      result = joint_position_client([180]*7, prefix)

    #test joint velocity control
    if (interactive == True):
      nb = input('Testing velocity control, press return, n to skip')
    if (nb != 'n' and nb != 'N'):
      if (nbJoints == 7):
    ...
    # test torque control
    if (interactive == True):
      nb = input('Testing torque control, press return, n to skip')
    if (nb != 'n' and nb != 'N'):    
    ...
    #test cartesian srv
    if (interactive == True):
      nb = input('Testing Cartesian control, press return, n to skip')
    if (nb != 'n' and nb != 'N'):
    ...
    if (interactive == True):
      nb = input('Testing Cartesian force control, press return, n to skip')
    if (nb != 'n' and nb != 'N'):
    ...
    #set null space mode
    if (interactive == True):
      nb = input('Testing Null space control control, use joystick to move robot in Null space, press return, n to skip')
    if (nb != 'n' and nb != 'N'):
